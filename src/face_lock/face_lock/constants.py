...
ARM_KP = 0.0037                                # proportional gain (rad / px)
ARM_DEADBAND_PX = 18.0                        # pixels from image centre to ignore
...
ARM_SERVO_SLEW_RATE_RAD_S = math.radians(45)   # max servo angular velocity (rad/s) — 45°/s
